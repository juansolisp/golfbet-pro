    ...
    try {
      if (isLogin) {
        ...
        await register(
          ...
          formData.password,
          formData.name,
          formData.handicap ? parseFloat(formData.handicap) : undefined,
        );
      }
      ...
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <p className="text-dark-400 text-sm mt-1">
            {isLogin ? 'Sign in to your GolfBet Pro account' : 'Join GolfBet Pro and start betting'}
          </p>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            {!isLogin && (
              <div>
                <label className="text-sm text-dark-300 mb-1.5 block">Name</label>
                <Input
            ...
            <div>
              <label className="text-sm text-dark-300 mb-1.5 block">Password</label>
              <Input
                type="password"
            ...
            {!isLogin && (
              <div>
                <label className="text-sm text-dark-300 mb-1.5 block">Handicap (optional)</label>
                <Input
                  type="number"
          ...
          <p className="text-center text-dark-400 text-sm mt-6">
            ...
            <button
              ...
              className="text-golf-400 font-medium hover:underline"
            >
